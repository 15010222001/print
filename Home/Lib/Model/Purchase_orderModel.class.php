<?php
//客户管理
class Purchase_orderModel extends RelationModel {
	//自动验证
	...
	public function updateOrderinfo($order_id){
	    ...
	    $purchase_order_goods = M('Purchase_order_goods');
	    $order_amount      = $purchase_order_goods->where($where)->sum('price*number');
