...
<title>操作日志|<?php echo ($configcache['Title']); ?></title>
...
<div id="content">
    ...
    <h3>
    	<a href="__URL__/?Status=0" <?php if($Status == 0): ?>class="h3a"<?php endif; ?> >成功记录</a>
        <a href="__URL__/?Status=1" <?php if($Status == 1): ?>class="h3a"<?php endif; ?> >失败操作</a>
    </h3>
    <table id="table" border="1" bordercolor="#CCCCCC" cellpadding="0" cellspacing="0">
        ...
        <?php if(is_array($volist)): $i = 0; $__LIST__ = $volist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tr <?php if(($mod) == "1"): ?>tr2<?php endif; ?>">
            ...
            <td class="tc"><a href="__URL__/?Uid=<?php echo ($vo["Uid"]); ?>" title="查看相似记录"><?php echo ($vo["Username"]); ?></a></td>
            <td><a href="__URL__/?Url=<?php echo ($vo["Url"]); ?>" title="查看相似记录"><?php echo ($vo["Url"]); ?></a></td>
            <td><?php echo ($vo["Description"]); ?></td>
            <td class="tc"><a href="__URL__/?Ip=<?php echo ($vo["Ip"]); ?>" title="查看相似记录"><?php echo ($vo["Ip"]); ?></a></td>
